...
Keep responses concise — 2-4 sentences max unless explaining a feature. Use plain language. No bullet points unless listing steps.`;
  ...
  const speak=(text)=>{
    ...
    const preferred=voices.find(v=>gender==="female"?femaleNames.some(n=>v.name.includes(n)):maleNames.some(n=>v.name.includes(n)))||voices.find(v=>v.lang==="en-US"&&v.localService);

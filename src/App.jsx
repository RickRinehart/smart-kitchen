...
export default function SmartKitchen({ tier="free", can={}, onUpgrade=()=>{}, user=null, viewerRole=null, onShowGuestViewer=null }){
  ...
  const periodDays={Daily:1,Weekly:7,Monthly:30}[budgetPeriod]||7;

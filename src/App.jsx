  ...
  const sendToDelivery=async()=>{
    ...
    try{
      ...
      if(d.url){
        ...
        if(d.fallback) alert("Instacart opened with your top items. For a full pre-built cart, add your Instacart API key in Settings.");
      } else {
      ...
      window.open("https://www.instacart.com/store/search_v3/term?term="+terms,"_blank");
    }
    setInstacartLoading(false);
  };

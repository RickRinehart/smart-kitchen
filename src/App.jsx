                  ...
                  {mealPlan.map((day,i)=>(
                    <div key={i} style={{background:C.card,border:"1px solid "+(day.quickMeal?"#f59e0b":C.border),borderRadius:seniorMode?16:12,padding:seniorMode?18:12}}>
                      ...
                      <div style={{display:"flex",gap:6,flexWrap:"wrap",alignItems:"center"}}>
                        ...
                        <button onClick={()=>setPhotoPromptMeal(day.meal)} style={{background:"transparent",border:"1px solid "+C.border,borderRadius:seniorMode?10:6,color:C.muted,cursor:"pointer",fontFamily:FM,fontSize:seniorMode?16:12,padding:seniorMode?"10px 14px":"8px 12px",flexShrink:0}} title="Add photo">📸 {mealPhotos[day.meal]?"Change":"Photo"}</button>
                    ...
                    <div key={d.id} style={{background:C.card,border:"1px solid "+(rating===1?C.red+"66":rating>=4?C.accent+"66":C.border),borderRadius:14,padding:18,cursor:"pointer",transition:"all 0.15s",opacity:rating===1?0.5:1}}
                      ...
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                        ...
                        <div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
                          ...
                          <button onClick={e=>{e.stopPropagation();setPhotoPromptMeal(d.name);}} style={{background:"transparent",border:"1px solid "+C.border,borderRadius:6,color:C.muted,fontFamily:FM,fontSize:seniorMode?16:12,padding:seniorMode?"8px 14px":"6px 10px",cursor:"pointer"}} title="Add photo">📸 {mealPhotos[d.name]?"Change":"Photo"}</button>
                        </div>
                      </div>
                    </div>
                  )})}

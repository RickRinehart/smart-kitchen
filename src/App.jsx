      ...
      {showWizard&&(
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          <div style={{background:C.surface,borderRadius:16,padding:28,maxWidth:440,width:"100%",border:"1px solid "+C.border}}>
            {wizardStep===-1&&(<div style={{textAlign:"center",padding:"8px 0"}}>
              ...
              <div style={{fontFamily:FM,fontSize:13,color:C.text,lineHeight:1.7,marginBottom:20}}>
                Your personal AI-powered kitchen assistant — designed to help your family eat well, waste less, and spend smarter.
              </div>
              <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:24,textAlign:"left"}}>
                {[
                  ...
                  <div key={title} style={{display:"flex",gap:12,alignItems:"flex-start",background:C.card,borderRadius:10,padding:"10px 12px"}}>
                    ...
                    <div>
                      <div style={{fontFamily:FD,fontSize:13,color:C.accent,marginBottom:2}}>{title}</div>
                      <div style={{fontFamily:FM,fontSize:11,color:C.muted,lineHeight:1.5}}>{desc}</div>
                    </div>
                  </div>
                ))}
              </div>
              <div style={{fontFamily:FM,fontSize:11,color:C.muted,marginBottom:16,lineHeight:1.6}}>
                Setup takes about 2 minutes. You can always update your preferences later.
              </div>

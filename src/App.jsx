...
export default function SmartKitchen({ tier="free", can={}, onUpgrade=()=>{}, user=null, viewerRole=null, onShowGuestViewer=null }){
  ...
  const familySummary=()=>{
    ...
    if(kitchenAppliances&&kitchenAppliances.length>0){
      ...
      if(all.length>0) s+="AVAILABLE COOKING EQUIPMENT (use these methods where appropriate to add variety): "+all.join(", ")+". ";
    }
    return s;
  };
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          <div style={{background:C.surface,borderRadius:16,padding:28,maxWidth:440,width:"100%",border:"1px solid "+C.border,maxHeight:"90vh",overflowY:"auto"}}>
            ...
            {wizardStep===5&&(<div>
              ...
              <div style={{fontFamily:FM,fontSize:seniorMode?15:12,color:C.muted,marginBottom:14,lineHeight:1.6}}>Tell us what cooking equipment you have. Smart Kitchen will suggest meals and methods that take advantage of your appliances.</div>

...
export default function SmartKitchen({ tier="free", can={}, onUpgrade=()=>{}, user=null }){
  ...
  const TOUR_STEPS=[
    ...
    {msg:"Now for the fun part — I'm opening your **Meal Plan** now! Hit Regenerate to build your first 7-day dinner plan based on your inventory and family needs.", tab:"mealplan", autoOpen:true, waitForDone:true, donePrompt:"Hit **Regenerate** to build your first meal plan. Say **done** or **next** when you've had a look! Any questions, just ask. 😊"},

        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          <div style={{background:C.surface,borderRadius:16,padding:28,maxWidth:440,width:"100%",border:"1px solid "+C.border,maxHeight:"90vh",overflowY:"auto"}}>
            {wizardStep===-2&&(<div style={{textAlign:"center",padding:"8px 0",maxHeight:"70vh",overflowY:"auto"}}>
              ...
              <div style={{fontFamily:"system-ui,-apple-system,sans-serif",fontSize:11,color:C.muted,fontStyle:"italic",marginBottom:12,lineHeight:1.8,textAlign:"center"}}>Most apps are created by developers for users.<br/>Smart Kitchen™ was created by a user, for users.</div>
